...
Modern web app using the built-in example dataset and default grouping settings (captured Dec 28, 2025 via Playwright E2E; lab notebook neo-brutalist styling applied):

![Animal Pairing and Grouping Tool™ app screenshot](modern-app/screenshots/example_run.png)

Recent verification (Dec 28, 2025):
